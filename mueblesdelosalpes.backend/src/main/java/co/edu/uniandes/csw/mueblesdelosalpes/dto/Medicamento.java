...
public class Medicamento
{
     ...
     */
    private TipoMedicamento presentacion;
     ...
     */
    public Medicamento(String nombre, String componente, String descripcion, TipoMedicamento presentacion, String posologia) {
        this.nombre = nombre;
    ...
    public TipoMedicamento getPresentacion() {
        return presentacion;
    }

    public void setPresentacion(TipoMedicamento presentacion) {
        this.presentacion = presentacion;
    }
